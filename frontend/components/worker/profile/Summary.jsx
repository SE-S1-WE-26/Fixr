...
const Summary = () => {
  return (
    <View className="flex mt-2 rounded-xl bg-powder border-4 border-platinum shadow px-4 md:px-5 py-4 md:py-5 mx-4 md:mx-6 justify-center">
      <View className="flex flex-row justify-between">
        <View className="grow flex-col bg-white bg-powder border-2 border-platinum shadow p-3 md:p-4 rounded-lg mr-2 md:mr-2 justify-center">
      ...
      <View className="flex flex-row justify-between items-center bg-white border-2 border-platinum shadow p-3 md:p-4 rounded-lg mt-2">
      ...
      <View className="flex flex-row justify-between mt-2">
        ...
        <View className="grow flex-row justify-between items-center bg-white border-2 border-platinum shadow p-3 md:p-4 rounded-lg ml-2 md:ml-2">
