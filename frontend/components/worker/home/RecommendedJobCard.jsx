...
const RecommendedJobCard = ({ job }) => {
  ...
  if (loading || !client) {
    return (
      <View className="flex min-h-[140px] min-w-[320px] max-w-[380px] border border-platinum my-2 rounded-xl bg-powder border-2 shadow px-4 py-3 justify-center ml-5 items-center">
  ...
  return (
    <View className="flex min-h-[140px] min-w-[320px] max-w-[380px]  md:min-w-[380px] md:max-w-[380px] my-2 rounded-xl bg-powder shadow px-4 py-3 justify-center ml-5 border border-platinum border-2">
