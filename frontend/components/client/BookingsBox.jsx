...
const BookingsBox = ({ type, topic, handyman, date, time, amount }) => {
    return (
        <SafeAreaView className={`rounded-xl mt-3 mx-auto shadow-smw-[340px] w-11/12 h-48 border border-gray-300 flex flex-col`} >
                ...
                <View className={`flex-row mt-4 justify-between px-1`}>
                    <View className={`bg-white border-2 border-yellow rounded-lg px-2.5 h-[30px] flex-row`}>
                        <TouchableOpacity>
                            <Text className="mt-0.5">View Handyman Profile</Text>
                        </TouchableOpacity>
                    </View>
